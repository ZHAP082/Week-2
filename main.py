...
#DM mass plot
plt.plot(Radias_data_array,Mass_DM, label = 'Dark matter')

plt.xlabel ('Radias / kpc')
plt.ylabel ('Mass / solar masses')
plt.title ('Mass of visible, dark and sum of mass against radias')

#Visible mass plot
plt.plot(Radias_data_array,Mass_data_array, label = 'Visual mass')

#Sum mass plot

plt.plot(Radias_data_array,Mass_sum, label = 'Combined mass')

plt.legend(['Dark matter','Visual mass','Combined mass'])
